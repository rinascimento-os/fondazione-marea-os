...
-- 8. Public stats RPC function (for the vetrina/showcase page)
-- Returns aggregated, anonymized data — no PII exposed.
-- SECURITY DEFINER bypasses RLS; granted to anon role for public access.
