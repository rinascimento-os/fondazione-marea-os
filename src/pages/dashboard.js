    ...
    <div id="dashboard-content">
        ...
        <a href="#/timebank" class="stat-card bg-white rounded-2xl border border-marea-border/60 p-6 card-hover block">
          <div class="flex items-center justify-between mb-3">
            <div class="flex items-center gap-1.5">
              ...
              <span class="tooltip">
                <svg class="w-3.5 h-3.5 text-marea-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z"/></svg>
                <span class="tooltip-text">Somma di tutte le ore di volontariato registrate</span>
              </span>
            </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <div class="lg:col-span-2 bg-white rounded-2xl border border-marea-border/60 shadow-sm p-6">
          <h3 class="text-lg text-marea-black mb-4">Ore di volontariato per mese</h3>
        ...
        <div class="bg-white rounded-2xl border border-marea-border/60 shadow-sm p-6">
          <h3 class="text-lg text-marea-black mb-4">Riepilogo matching</h3>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        <div class="lg:col-span-2 bg-white rounded-2xl border border-marea-border/60 shadow-sm p-6">
          <h3 class="text-lg text-marea-black mb-4">Competenze pi&ugrave; diffuse nella rete</h3>
