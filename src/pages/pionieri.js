  ...
  const iconField = (icon, label, value) => {
    return `
      <div class="flex items-start gap-3">
        <span class="w-8 h-8 rounded-lg bg-${value ? 'white' : 'gray-50'} flex items-center justify-center flex-shrink-0 mt-0.5">
          ${icon}
        </span>
        <div>
    ...
    <div class="space-y-5">
      ...
      <div class="bg-marea-cream/50 rounded-xl p-4 space-y-3">
        <div class="flex items-center gap-3">
          <span class="w-8 h-8 rounded-lg bg-${pioniere.email ? 'white' : 'gray-50'} flex items-center justify-center flex-shrink-0">
